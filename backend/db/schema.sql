...
CREATE TABLE IF NOT EXISTS users (
  ...
  role             TEXT NOT NULL CHECK (role IN ('head_admin', 'fleet_manager', 'manager', 'driver')),
...
-- —— SUPABASE RPC: refresh_trip_summary(trip_id) ————————————————
...
-- —— SUPABASE RPC: archive_ended_trip_logs(...) ————————————————
